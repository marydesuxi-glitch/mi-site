...
function CtaSecondary() {
  return (
    <div className="content-stretch flex items-center px-[20px] py-[14px] relative rounded-[999px] shrink-0" data-name="cta-secondary">
      ...
      <a className="[word-break:break-word] block font-['Geist:SemiBold',sans-serif] font-semibold leading-[0] relative shrink-0 text-[#141414] text-[15px] whitespace-nowrap" href="https://apps.apple.com/us/app/home-planner-room-design-3d/id1451474641?mt=12" target="_blank">
